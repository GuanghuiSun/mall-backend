...
public class MessageConstant {
    ...
    public static final String REQUEST_PARAM_EMPTY_ERROR = "请求参数为空！";
    public static final String GET_ERROR = "获取信息失败";
    public static final String LOGIN_ERROR = "用户未登录";
    public static final String REQUEST_ERROR = "用户请求业务失败";
    public static final String SERVER_INTERNAL_ERROR = "服务器错误";

    /**
     * 错误信息详情描述
     */
    public static final String REPEAT_USERNAME_FAIL = "用户名已存在！";
    ...
    public static final String ADD_LIMIT_FAIL = "添加失败,已达限购数量！";
    public static final String ADD_REPEAT_FAIL = "添加失败,请勿重复添加！";
    ...
    public static final String GET_HOT_PRODUCT_ERROR = "获取热门商品错误！";
